...
from ClassifierDatasets import MLPDatasetValidated
...
class MLPMSEHeatMap(pl.LightningModule):
    ...
    def __init__(self, learning_rate=0.008317637711026709,
        ...
        super(MLPMSEHeatMap, self).__init__() # changed from super(AEHeronModel, self).__init__(), seems to be jupyter issue
